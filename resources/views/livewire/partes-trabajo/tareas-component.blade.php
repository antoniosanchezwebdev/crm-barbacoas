    ...
    @mobile
        @if ($tarea != null)
            @if ($tab == 'tab1')
                    ...
                    <div class="row">
                        <div class="col-6 d-grid gap-2">
                            <button type="button" class="btn btn-tab btn-block" wire:click="cambioTab('tab1')">Consultar
                                partes de trabajo</button>
                        </div>
                        <div class="ms-auto col-6 d-grid gap-2">
                            <button type="button" class="btn btn-outline-tab btn-block" wire:click="cambioTab('tab2')">Añadir
                                parte de trabajo</button>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="ms-auto col-6 d-grid gap-2">
                            <button type="button" class="btn btn-outline-tab btn-block"
                                wire:click="cambioTab('tab3')">Editar parte de trabajo</button>
                        </div>
                        <div class="ms-auto col-6 d-grid gap-2">
                            <button type="button" class="btn btn-outline-tab btn-block"
                ...
                @livewire('partes-trabajo.index-component')
            @elseif ($tab == 'tab2')
                <div style="border-bottom: 1px solid black !important;">
                    <div class="row">
                        <div class="col-6 d-grid gap-2">
                            <button type="button" class="btn btn-outline-tab btn-block"
                                wire:click="cambioTab('tab1')">Consultar partes de trabajo</button>
                        </div>
                        <div class="ms-auto col-6 d-grid gap-2">
                            <button type="button" class="btn btn-tab btn-block" wire:click="cambioTab('tab2')">Tareas
                                asignadas</button>
                        </div>
                    </div>
                    <br>
                ...
                @livewire('partes-trabajo.create-component')
            ...
            @elseif ($tab == 'tab3')
                <div style="border-bottom: 1px solid black !important;">
                    <div class="row">
                        ...
                        <div class="ms-auto col-6 d-grid gap-2">
                            <button type="button" class="btn btn-outline-tab btn-block"
                                wire:click="cambioTab('tab2')">Añadir parte de trabajo</button>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                ...
                @livewire('partes-trabajo.edit-component', ['identificador' => $tarea], key('tab3'))
            @elseif ($tab == 'tab4')
                <div style="border-bottom: 1px solid black !important;">
                    <div class="row">
                        <div class="col-6 d-grid gap-2">
            ...
            @elseif ($tab == 'tab2')
                <div style="border-bottom: 1px solid black !important;">
                    <div class="row">
                        ...
                        <div class="ms-auto col-6 d-grid gap-2">
                            <button type="button" class="btn btn-tab btn-block" wire:click="cambioTab('tab2')">Añadir
                                parte de trabajo</button>
                        </div>
                    </div>
                    <br>
        ...
        @if ($tarea != null)
                ...
                <ul class="nav nav-tabs nav-fill">
                    <li class="nav-item">
                        <button class="nav-link" wire:click.prevent="cambioTab('tab1')">
                            <h5> Consultar partes de trabajo</h5>
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" wire:click.prevent="cambioTab('tab2')">
                            <h3>Añadir parte de trabajo</h3>
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" wire:click.prevent="cambioTab('tab3')">
            ...
            @elseif ($tab == 'tab4')
                <ul class="nav nav-tabs nav-fill">
                    <li class="nav-item">
                        <button class="nav-link" wire:click.prevent="cambioTab('tab1')">
                            <h5> Consultar partes de trabajo
                        </button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" wire:click.prevent="cambioTab('tab2')">
