...
<body>
    <div class="container-fluid h-100" style="background-color:#121828;">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-9">
                <a href="{{route('seleccion', ['boton' => 'sayco'])}}" class="btn btn-primary"
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-9">
                <a href="{{route('seleccion', ['boton' => 'sancer'])}}"  class="btn btn-primary" style="width:100% !important; height:150% !important; margin-bottom: -40px !important;">
